...
typedef SWIFT_ENUM_NAMED(NSInteger, FIRActionCodeOperation, "ActionCodeOperation", closed) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, FIRAuthAPNSTokenType, "AuthAPNSTokenType", closed) {
/// Unknown token type.
...
typedef SWIFT_ENUM_NAMED(NSInteger, FIRAuthErrorCode, "AuthErrorCode", closed) {
