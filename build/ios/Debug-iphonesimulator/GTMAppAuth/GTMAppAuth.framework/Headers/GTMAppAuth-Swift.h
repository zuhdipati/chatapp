...
typedef SWIFT_ENUM_NAMED(NSInteger, GTMAuthSessionErrorCode, "ErrorCode", closed) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, GTMKeychainStoreErrorCode, "ErrorCode", closed) {
